...
var apiInstance = new PublicRestApi.PaymentApi();
...
var createPurchase = function createPurchase() {
  var client = new PublicRestApi.ClientDetails("test@test.com");
  var product = new PublicRestApi.Product("Test", 100);
  var details = new PublicRestApi.PurchaseDetails([product]);
  var purchase = new PublicRestApi.Purchase();
...
var cancelPurchase = function cancelPurchase() {
  apiInstance.purchasesCancel("purchase_id", callback);
};
var releasePurchase = function releasePurchase() {
  apiInstance.purchasesRelease("purchase_id", callback);
};
var capturePurchase = function capturePurchase() {
  apiInstance.purchasesCapture("purchase_id", 100, callback);
};
var refundPurchase = function refundPurchase() {
  apiInstance.purchasesRefund("purchase_id", 100, callback);
};
var chargePurchase = function chargePurchase() {
  apiInstance.purchasesCharge("purchase_id", "recurring_token", callback);
};
var deleteRecurringToken = function deleteRecurringToken() {
  apiInstance.purchasesDeleteRecurringToken("purchase_id", callback);
};
var verify = function verify() {
  var content = "Hello, World!";
  var signature = "";
  ...
  var result = apiInstance.verify(content, Buffer.from(signature, 'base64'), publicKey);
  console.log(result);
};
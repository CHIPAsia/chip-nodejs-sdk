    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('client')) {
                obj['client'] = ApiClient.convertToType(data['client'], ClientDetails);
            }
            if (data.hasOwnProperty('purchase')) {
                obj['purchase'] = PurchaseDetails.constructFromObject(data['purchase']);
            }
            if (data.hasOwnProperty('payment')) {
                obj['payment'] = ApiClient.convertToType(data['payment'], PaymentDetails);
            }
            if (data.hasOwnProperty('issuer_details')) {
                obj['issuer_details'] = ApiClient.convertToType(data['issuer_details'], IssuerDetails);
            }
            if (data.hasOwnProperty('transaction_data')) {
                obj['transaction_data'] = ApiClient.convertToType(data['transaction_data'], Object);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = PurchaseStatus.constructFromObject(data['status']);
            }
            if (data.hasOwnProperty('status_history')) {
                obj['status_history'] = ApiClient.convertToType(data['status_history'], [Object]);
            }
            if (data.hasOwnProperty('viewed_on')) {
                obj['viewed_on'] = ApiClient.convertToType(data['viewed_on'], 'Number');
            }
            ...
            if (data.hasOwnProperty('billing_template_id')) {
                obj['billing_template_id'] = ApiClient.convertToType(data['billing_template_id'], 'String');
            }
            if (data.hasOwnProperty('client_id')) {
                obj['client_id'] = ApiClient.convertToType(data['client_id'], 'String');
            }
            if (data.hasOwnProperty('send_receipt')) {
                obj['send_receipt'] = ApiClient.convertToType(data['send_receipt'], 'Boolean');
            }
            if (data.hasOwnProperty('is_recurring_token')) {
                obj['is_recurring_token'] = ApiClient.convertToType(data['is_recurring_token'], 'Boolean');
            }
            if (data.hasOwnProperty('recurring_token')) {
                obj['recurring_token'] = ApiClient.convertToType(data['recurring_token'], 'String');
            }
            if (data.hasOwnProperty('skip_capture')) {
                obj['skip_capture'] = ApiClient.convertToType(data['skip_capture'], 'Boolean');
            }
            if (data.hasOwnProperty('force_recurring')) {
                obj['force_recurring'] = ApiClient.convertToType(data['force_recurring'], 'Boolean');
            }
            if (data.hasOwnProperty('reference_generated')) {
                obj['reference_generated'] = ApiClient.convertToType(data['reference_generated'], 'String');
            }
            ...
            if (data.hasOwnProperty('refund_availability')) {
                obj['refund_availability'] = ApiClient.convertToType(data['refund_availability'], 'String');
            }
            if (data.hasOwnProperty('refundable_amount')) {
                obj['refundable_amount'] = ApiClient.convertToType(data['refundable_amount'], 'Number');
            }
            if (data.hasOwnProperty('currency_conversion')) {
                obj['currency_conversion'] = ApiClient.convertToType(data['currency_conversion'], Object);
            }
            if (data.hasOwnProperty('payment_method_whitelist')) {
                obj['payment_method_whitelist'] = ApiClient.convertToType(data['payment_method_whitelist'], ['String']);
            }
            if (data.hasOwnProperty('success_redirect')) {
                obj['success_redirect'] = ApiClient.convertToType(data['success_redirect'], 'String');
            }
            if (data.hasOwnProperty('failure_redirect')) {
                obj['failure_redirect'] = ApiClient.convertToType(data['failure_redirect'], 'String');
            }
            if (data.hasOwnProperty('cancel_redirect')) {
                obj['cancel_redirect'] = ApiClient.convertToType(data['cancel_redirect'], 'String');
            }
            ...
            if (data.hasOwnProperty('creator_agent')) {
                obj['creator_agent'] = ApiClient.convertToType(data['creator_agent'], 'String');
            }
            ...
            if (data.hasOwnProperty('created_from_ip')) {
                obj['created_from_ip'] = ApiClient.convertToType(data['created_from_ip'], 'String');
            }
            ...
            if (data.hasOwnProperty('direct_post_url')) {
                obj['direct_post_url'] = ApiClient.convertToType(data['direct_post_url'], 'String');
            }
        }
        return obj;
    }
